...
public:
    ...
    UFUNCTION(BlueprintPure, Category="METSE|Update") int64 GetActiveSequence() const { return ActiveSequence; }
...
private:
    ...
    bool IsTrustedHttpsUrl(const FString& Url, FString& OutError) const;
