...
req('TacticalAICore tacticalAI_' in engine and 'syncTacticalAI()' in engine and 'tacticalAI_.fixedStep' in engine,'Tactical AI must be simulation-owned, not a detached demo')
