...
req((ROOT/'VERSION').read_text().strip()=='0.3.0','VERSION must be 0.3.0')
req((ROOT/'BUILD').read_text().strip()=='8','BUILD must be 8')
...
proj=(ROOT/'project.yml').read_text(); req('MARKETING_VERSION: "0.3.0"' in proj,'project version must be 0.3.0'); req('CURRENT_PROJECT_VERSION: "8"' in proj,'project build must be 8'); req('TARGETED_DEVICE_FAMILY: "1"' in proj,'iPhone-only project required'); req('GENERATE_INFOPLIST_FILE: NO' in proj,'Generated plist forbidden')

required=[
'Engine/Core/METSEInputCommandQueue.hpp','Engine/Core/METSEInputCommandQueue.cpp','Engine/Core/METSECharacterMotor.hpp','Engine/Core/METSECharacterMotor.cpp','Engine/Core/METSEWeaponCore.hpp','Engine/Core/METSEWeaponCore.cpp','Engine/Core/METSEWorldCollision.hpp','Engine/Core/METSEWorldCollision.cpp','Engine/Core/METSEDamageCore.hpp','Engine/Core/METSEDamageCore.cpp','Engine/Core/METSEBallisticsCore.hpp','Engine/Core/METSEBallisticsCore.cpp','Engine/Core/METSEVisibilityCore.hpp','Engine/Core/METSEVisibilityCore.cpp','Engine/Core/METSEObservatoryCore.hpp','Engine/Core/METSEObservatoryCore.cpp','Engine/Core/METSEIntegrityCore.hpp','Engine/Core/METSEIntegrityCore.cpp','Engine/Core/METSEEngineCore.hpp','Engine/Core/METSEEngineCore.cpp','Engine/Platform/Apple/METSEEngineBridge.mm','Shaders/METSERenderer.metal','iOS/METSE/ObservatoryViewController.swift']
for r in required: req((ROOT/r).exists(),f'Required Build008 source missing: {r}')
...
for token in ('rejectedCritical','deterministicStateHash','HitRegion::Head','onePercentLowFPS','low roof','quiet_NaN'):
    req(token in tests,f'Build008 regression coverage missing: {token}')
...
if errors:
    print('METSE BUILD 008 GUARDRAILS: FAIL'); [print(' -',e) for e in errors]; sys.exit(1)
print('METSE BUILD 008 GUARDRAILS: PASS')
