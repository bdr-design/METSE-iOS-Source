...
struct GameplayDenialMetrics{std::uint64_t fireCooldown=0,fireReloading=0,fireObstructed=0,fireEmpty=0,projectileCapacity=0,reloadInvalid=0,autoReloadStarted=0;};
