...
namespace metse {
struct EngineConfig{double fixedStepSeconds=1.0/60.0;std::uint32_t maxCatchUpSteps=4,maxCombatants=32;CharacterConfig character{};WeaponConfig weapon{};TacticalAIConfig tacticalAI{};};
