...
final class ObservatoryViewController: UIViewController {
    ...
    private func configureUI() {
        ...
        let title = UILabel(); title.text = "مركز الأرصاد V4"; title.font = .systemFont(ofSize: 24, weight: .bold); title.textColor = .white
